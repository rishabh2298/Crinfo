...
public class GetCriminalRecord {
	
	public void values() {
		
		Scanner input = new Scanner(System.in);

		System.out.println("Enter department-id to get it's criminal record");
		...
		try {
			...
			List<CriminalDetails> criminals = dao.getCriminalRecord(departmentId);
